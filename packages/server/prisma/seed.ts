...
async function main() {
  ...
  const user = await prisma.user.upsert({
    where: { email: 'admin@aigc-mas.com' },
    update: {},
    create: {
      name: '系统管理员',
      email: 'admin@aigc-mas.com',
      role: 'admin',
    },
  });
  ...
  const demoProjects = [
    ...
    },
    {
      ...
      tags: toJSON(['企业宣传', '科技', '品牌']),
      corporateVideo: {
        companyName: '智创科技有限公司',
        industry: '人工智能/科技',
        videoType: '企业宣传片',
        keySellingPoints: toJSON(['技术领先', '团队专业', '服务优质', '创新能力强']),
    ...
    },
    {
      ...
      tags: toJSON(['文旅', '丽江', '古城', '旅游']),
      tourismPromo: {
        location: '云南丽江古城',
        attractions: toJSON(['丽江古城', '玉龙雪山', '束河古镇', '泸沽湖']),
        culturalHighlights: toJSON(['纳西族文化', '东巴文', '白沙壁画', '纳西古乐']),
